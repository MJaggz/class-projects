...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        //Create the smart nodes preStart and postFinish.
        this.preStart = new Node();
        this.postFinish = new Node();

        //Initialize lastLeft node to point to preStart
        ...
        //Initialize the sizes of the right and left lengths.
        this.rightLength = 0;
        this.leftLength = 0;
    }
    ...
    public List3() {
        ...
        //Initialize the double linked list structure.
        this.createNewRep();
    ...
    public final void addRightFront(T x) {
        ...
        //Increment the right length because of the added element to the right.
        this.rightLength++;
    ...
    public final T removeRightFront() {
        ...
        //Get the node right after lastLeft
        Node p = this.lastLeft;
        Node q = p.next;

        //Remove q and fix the links.
        p.next = q.next;
        p.next.previous = p;

        //Extract the data from q.
        T x = q.data;

        //Decrement rightLength because of the removed element.
        this.rightLength--;
    ...
    public final void advance() {
        ...
        //Set lastLeft to point to the next node.
        Node p = this.lastLeft;
        this.lastLeft = p.next;

        //Increment the leftLength while also decrementing the rightLength.
        this.leftLength++;
        this.rightLength--;
    ...
    public final void moveToStart() {
        ...
        //Move lastLeft to preStart.
        this.lastLeft = this.preStart;

        //Making sure that all the elements are now on the right.
    ...
    public final int rightLength() {
        ...
        assert this.conventionHolds();
        //Return the current rightLength.
    ...
    public final void moveToFinish() {
        ...
        //Move lastLeft to be the last element before postFinish.
        this.lastLeft = this.postFinish.previous;

        //Ensuring that all the elements are now on the left.
    ...
    public final void retreat() {
        ...
        //Move lastLeft to previous.
        Node p = this.lastLeft;
        this.lastLeft = p.previous;

        //Decrement the leftLength while also incrementing the rightLength.
        this.leftLength--;
        this.rightLength++;
