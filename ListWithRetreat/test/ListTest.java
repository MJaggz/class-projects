...
public abstract class ListTest {
    ...
    /*
     * Test cases for other retreat method.
     */

    /**
     * Retreat test method simple, boundary test.
     */
    @Test
    ...
    /**
     * Retreat test method normal test.
     */
    @Test
    public final void testRetreatBothHaveEntries() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "red", "orange", "green");
        List<String> list2 = this.createFromArgsRef(2, "red", "orange", "green");
        /*
         * Call method under test
         */
        list1.retreat();
    ...
    /**
     * Retreat test method challenging.
     */
    @Test
    public final void testRetreatBothHaveTonEntries() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(12, "red", "orange", "green",
                "Bengals", "Browns", "Emanuel", "Mohamed", "Football", "Basketball",
                "Baseball", "NFL", "NBA");
        List<String> list2 = this.createFromArgsRef(11, "red", "orange", "green",
                "Bengals", "Browns", "Emanuel", "Mohamed", "Football", "Basketball",
                "Baseball", "NFL", "NBA");
        /*
         * Call method under test
    ...
    @Test
    public final void testRetreatLeftOneRightNoTEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "Mohamed", "Emanuel", "Orange",
                "Green");
        List<String> list2 = this.createFromArgsRef(0, "Mohamed", "Emanuel", "Orange",
                "Green");
        /*
         * Call method under test
         */
    ...
    @Test
    public final void testRetreatLeftNonEmptyRightNotEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "Emanuel", "orange", "green",
                "Mohamed");
        List<String> list2 = this.createFromArgsRef(1, "Emanuel", "orange", "green",
                "Mohamed");
        /*
         * Call method under test
         */
