...
public abstract class StatementTest {
    ...
    private static final String FILE_NAME_2 = "data/EmptyStatement.bl";
    ...
    @Test
    public final void testKindFromEmptyStatement() {
        /*
         * Setup
         */
    ...
    @Test
    public final void testAddToBlockFromEmptyStatement() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_2);
        Statement sRef = this.createFromFileRef(FILE_NAME_2);
        Statement sTestAdd = sTest.newInstance();
        sTestAdd.assembleCall("move");
        Statement sRefAdd = sRef.newInstance();
        sRefAdd.assembleCall("move");
        sRef.addToBlock(0, sRefAdd);

        /*
         * Calling method
         */
        sTest.addToBlock(0, sTestAdd);

        /*
         * Evaluation
         */
        assertEquals(sRef, sTest);
        assertEquals(sRefAdd, sTestAdd);
    ...
    @Test
    public final void testLengthEmptyStatement() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_2);
    ...
    @Test
    public final void testAssembleCallFiles1n2() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_2);
        ...
        Statement blockTest = this.createFromFileTest(FILE_NAME_1);
        Statement blockRef = this.createFromFileRef(FILE_NAME_1);
        Statement callTest = blockTest.removeFromBlock(0);
        Statement callRef = blockRef.removeFromBlock(0);
         ...
         */
        assertEquals(sRef, sTest);
        assertEquals(blockRef, blockTest);
        assertEquals(callRef, callTest);
