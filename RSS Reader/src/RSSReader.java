...
public final class RSSReader {
    ...
    private static void outputHeader(XMLTree channel, SimpleWriter out) {
        ...
        out.println("</head>");
        out.println("<body>");
        ///Store the title and hyperlink it.///
        String yahooLink = ("http://news.yahoo.com");

        out.println("<h1><a href=\"" + yahooLink
                + "\">Yahoo News - Latest News & Headlines</a></h1>");
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
        ...
        ///Open the table row for this process.///
        out.println("<tr>");
        ...
        ///Check to see if there is a "pudDate" attribute and if there is
        ///store it.///
    ...
    public static void main(String[] args) {
        ...
        ///Prompt the user for a valid RSS 2.0 feed.////
        out.println("Please enter the URL of a RSS 2.0 feed: ");
        String link = in.nextLine();
        ///Make a XMLTree from the users link.///
        XMLTree t = new XMLTree1(link);
        ///Check to see if the users' link is RSS 2.0. If not, leave loop.///

        if (t.attributeValue("version").equals("2.0")
                && t.hasAttribute("version") && t.label().equals("rss")) {
            ///If user's link is valid, ask for an output file name.
            out.println("Enter an output file name (adding .html extention): ");
            ...
            ///If RSS feed is not 2.0, ask the user to try again.///
            out.println(
                    "You have not entered a valid RSS 2.0 feed, please try again");
        }
